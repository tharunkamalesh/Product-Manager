...
export const RightRail = ({ result, memory, useMemory, onToggleUseMemory, onSetGoal, onClear }: RightRailProps) => {
  ...
  const handleCreateJira = async () => {
    ...
    // For demo/MVP, we take the highest priority task
    ...
    // Find the mapped assignee for this category
    ...
    try {
      ...
      toast.success("Jira Task Created Successfully", {
        id: toastId,
        description: `Ticket ${data.issueKey} is now live in your project.`,
        action: {
          label: "View in Jira",
